    ...
    public function onCommand(CommandSender $sender, Command $command, string $label, array $args): bool
    {
        if (!($sender instanceof Player) || !$sender->isOp()) {
            switch (strtolower(array_shift($args))):
                ...
                case 'join':
                    if (!(count($args) < 0b11)) {
                        $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Usage: /sw ' . TextFormat::GREEN . 'join [SWname]' . TextFormat::GRAY . ' [PlayerName]');
                        break;
                    }
                    ...
                    if (isset($args[0])) {
                        ...
                        if (!array_key_exists($SWname, $this->pg->arenas)) {
                            $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Arena with name: ' . TextFormat::WHITE . $SWname . TextFormat::RED . ' doesn\'t exist');
                            break;
                        }
                    } else {
                    ...
                    if (strlen($player) > 0 && $sender instanceof \pocketmine\command\ConsoleCommandSender) {
                        ...
                        if ($p instanceof Player) {
                            if ($this->pg->inArena($p->getName())) {
                                $p->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'You are already inside an arena');
                                break;
                            }
                        ...
                        if ($this->pg->inArena($sender->getName())) {
                            $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'You are already inside an arena');
                            break;
                        }
                ...
                case 'quit':
                    if (!empty($args)) {
                        $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Usage: /sw ' . TextFormat::GREEN . 'quit');
                        break;
                    }
                ...
                default:
                    ...
                    $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Usage: /sw [join|quit]');
                    break;
        ...
        switch (strtolower(array_shift($args))):
            ...
            case 'create':
                ...
                */
                if (!(count($args) > 0b11 && count($args) < 0b101)) {
                    $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Usage: /sw ' . TextFormat::GREEN . 'create [SWname] [slots] [countdown] [maxGameTime]');
                    break;
                }
                ...
                if ($sender->getServer()->getConfigString('level-name', 'world') == $world || $sender->getServer()->getDefaultLevel()->getName() == $world || $sender->getServer()->getDefaultLevel()->getFolderName() == $world) {
                    $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'You can\'t create an arena in the default world');
                    unset($fworld, $world);
                    break;
                }
                ...
                foreach ($this->pg->arenas as $aname => $arena) {
                    if ($arena->getWorld() == $world) {
                        $sender->sendMessage(TextFormat::RED . 'â' . TextFormat::RED . 'You can\'t create 2 arenas in the same world try:');
                        $sender->sendMessage(TextFormat::RED . 'â' . TextFormat::WHITE . '/sw list' . TextFormat::RED . ' for a list of arenas');
                        $sender->sendMessage(TextFormat::RED . 'â' . TextFormat::WHITE . '/sw delete' . TextFormat::RED . ' to delete an arena');
                        unset($fworld, $world);
                        break 2;
                    }
                }
                ...
                foreach ($this->pg->signs as $loc => $name) {
                    if (explode(':', $loc)[3] == $world) {
                        $sender->sendMessage(TextFormat::RED . 'â' . TextFormat::RED . 'You can\'t create an arena in the same world of a join sign:');
                        $sender->sendMessage(TextFormat::RED . 'â' . TextFormat::WHITE . '/sw signdelete' . TextFormat::RED . ' to delete signs');
                        unset($fworld, $world);
                        break 2;
                    }
                }
                ...
                if (!($SWname && preg_match('/^[a-z0-9]+[a-z0-9]$/i', $SWname) && strlen($SWname) < 0x10 && strlen($SWname) > 0b10)) {
                    $sender->sendMessage(TextFormat::WHITE . 'â' . TextFormat::AQUA . '[SWname]' . TextFormat::RED . ' must consists of a-z 0-9 (min3-max15)');
                ...
                if (array_key_exists($SWname, $this->pg->arenas)) {
                    $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Arena with name: ' . TextFormat::WHITE . $SWname . TextFormat::RED . ' already exist');
                    unset($fworld, $world, $SWname);
                    break;
                }
                ...
                if (!($slot && is_numeric($slot) && is_int(($slot + 0)) && $slot < 0x33 && $slot > 1)) {
                    $sender->sendMessage(TextFormat::WHITE . 'â' . TextFormat::AQUA . '[slots]' . TextFormat::RED . ' must be an integer >= 50 and >= 2');
                ...
                if (!($countdown && is_numeric($countdown) && is_int(($countdown + 0)) && $countdown > 0b1001 && $countdown < 0x12d)) {
                    $sender->sendMessage(TextFormat::WHITE . 'â' . TextFormat::AQUA . '[countdown]' . TextFormat::RED . ' must be an integer <= 300 seconds (5 minutes) and >= 10');
                ...
                if (!($maxtime && is_numeric($maxtime) && is_int(($maxtime + 0)) && $maxtime > 0x12b && $maxtime < 0x259)) {
                    $sender->sendMessage(TextFormat::WHITE . 'â' . TextFormat::AQUA . '[maxGameTime]' . TextFormat::RED . ' must be an integer <= 600 (10 minutes) and >= 300');
                ...
                //ARENA LEVEL NAME
                if ($fworld == $world) {
                    //$sender->sendMessage(TextFormat::WHITE . 'â' . TextFormat::RED . 'Using the world were you are now: ' . TextFormat::AQUA . $world . TextFormat::RED . ' ,expected lag');
                } else {
                    $sender->sendMessage(TextFormat::WHITE . 'â' . TextFormat::RED . 'There is a problem with the world name, try to restart your server');
                ...
                //$sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::LIGHT_PURPLE . 'I\'m creating a backup of the world...teleporting to hub');
                //TODO: Remove this (pmmp messages queue)
                $pk = new \pocketmine\network\mcpe\protocol\TextPacket();
                $pk->type = \pocketmine\network\mcpe\protocol\TextPacket::TYPE_RAW;
                $pk->message = TextFormat::AQUA . 'â' . TextFormat::LIGHT_PURPLE . 'I\'m creating a backup of the world ' . TextFormat::AQUA . $world . TextFormat::LIGHT_PURPLE . ', do not move';
                ...
                $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::GREEN . 'Arena: ' . TextFormat::DARK_GREEN . $SWname . TextFormat::GREEN . ' created successfully!');
                $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::GREEN . 'Now set spawns with ' . TextFormat::WHITE . '/sw setspawn [slot]');
            ...
            case 'setspawn':
                ...
                */
                if (count($args) != 1) {
                    $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Usage: /sw ' . TextFormat::GREEN . 'setspawn [slot]');
                    break;
                }
                ...
                if (!($SWname && preg_match('/^[a-z0-9]+[a-z0-9]$/i', $SWname) && strlen($SWname) < 0x10 && strlen($SWname) > 0b10 && array_key_exists($SWname, $this->pg->arenas))) {
                    $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Arena not found here, try ' . TextFormat::WHITE . '/sw create');
                    unset($SWname);
                    break;
                }
                ...
                if (!($slot && is_numeric($slot) && is_int(($slot + 0)) && $slot < 0x33 && $slot > 0)) {
                    $sender->sendMessage(TextFormat::WHITE . 'â' . TextFormat::AQUA . '[slot]' . TextFormat::RED . ' must be an integer <= than 50 and >= 1');
                    unset($SWname, $slot);
                    break;
                }
                $slot += 0;
                ...
                if ($sender->getLevel()->getName() == $this->pg->arenas[$SWname]->getWorld()) {
                    if ($this->pg->arenas[$SWname]->setSpawn($sender, $slot)) {
                        $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::GREEN . 'New spawn: ' . TextFormat::WHITE . $slot . TextFormat::GREEN . ' In arena: ' . TextFormat::WHITE . $SWname);
                        if ($this->pg->arenas[$SWname]->checkSpawns())
                            $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::GREEN . 'I found all the spawns for Arena: ' . TextFormat::WHITE . $SWname . TextFormat::GREEN . ', now you can create a join sign!');
                    }
                }
                break;
            ...
            case 'list':
                ...
                */
                if (count($this->pg->arenas) > 0) {
                    $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::GREEN . 'Loaded arenas:');
                    foreach ($this->pg->arenas as $key => $val) {
                        $sender->sendMessage(TextFormat::BLACK . 'â ' . TextFormat::YELLOW . $key . TextFormat::AQUA . ' [' . $val->getSlot(true) . '/' . $val->getSlot() . ']' . TextFormat::DARK_GRAY . ' => ' . TextFormat::GREEN . $val->getWorld());
                    }
                } else {
                    $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'There aren\'t loaded arenas, create one with ' . TextFormat::WHITE . '/sw create');
                }
                break;
            ...
            case 'delete':
                ...
                */
                if (count($args) != 1) {
                    $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Usage: /sw ' . TextFormat::GREEN . 'delete [SWname]');
                    break;
                }

                $SWname = array_shift($args);
                if (!($SWname && preg_match('/^[a-z0-9]+[a-z0-9]$/i', $SWname) && strlen($SWname) < 0x10 && strlen($SWname) > 0b10 && array_key_exists($SWname, $this->pg->arenas))) {
                    $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Arena: ' . TextFormat::WHITE . $SWname . TextFormat::RED . ' doesn\'t exist');
                    unset($SWname);
                    break;
                }

                if (!(is_dir($this->pg->getDataFolder() . 'arenas/' . $SWname) && is_file($this->pg->getDataFolder() . 'arenas/' . $SWname . '/settings.yml'))) {
                    $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Arena files doesn\'t exists');
                    unset($SWname);
                    break;
                }

                $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::GREEN . 'Please wait, this can take a bit');
                ...
                $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::GREEN . 'Arena: ' . TextFormat::DARK_GREEN . $SWname . TextFormat::GREEN . ' Deleted !');
            ...
            case 'signdelete':
                ...
                */
                if (count($args) != 1) {
                    $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Usage: /sw ' . TextFormat::GREEN . 'signdelete [SWname|all]');
                    break;
                }
                ...
                if (!array_key_exists($SWname, $this->pg->arenas)) {
                    if ($SWname == 'all') {
                        ...
                        $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::GREEN . 'Deleted all SW signs !');
                        unset($SWname, $loc, $name, $ex, $block);
                    } else {
                        $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Arena: ' . TextFormat::WHITE . $SWname . TextFormat::RED . ' doesn\'t exist');
                        unset($SWname);
                ...
                $this->pg->setSign($SWname, 0, 0, 0, 'world', true, false);
                $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::GREEN . 'Deleted signs for arena: ' . TextFormat::DARK_GREEN . $SWname);
                unset($SWname, $loc, $name, $ex, $block);
                break;
            ...
            default:
                //No option found, usage
                $sender->sendMessage(TextFormat::AQUA . 'â' . TextFormat::RED . 'Usage: /sw [create|setspawn|list|delete|signdelete]');
                break;
